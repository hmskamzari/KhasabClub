...
return [
    ...
    'sections' => [
        ...
        'information_desc' => 'Configure a time slot for a court',
    ...
    'modals' => [
        ...
        'generate_slots_description'   => 'Creates one time slot for each available date of the selected court (respecting its open days, if any). Existing slots for a date/time combination are left untouched.',
    ...
    'empty_state' => [
        ...
        'description' => 'Create time slots for your courts to enable bookings.',
    ],
