...
return [
    ...
    'sections' => [
        ...
        'information_desc' => 'تهيئة الفترة الزمنية لملعب',
    ...
    'modals' => [
        ...
        'generate_slots_description'   => 'ينشئ فترة زمنية واحدة لكل تاريخ متاح للملعب المحدد (مع مراعاة أيام الفتح إن وجدت). الفترات الموجودة مسبقًا لنفس التاريخ والوقت لا تتأثر.',
    ...
    'empty_state' => [
        ...
        'description' => 'أنشئ فترات زمنية لملاعبك لتفعيل الحجوزات.',
    ],
