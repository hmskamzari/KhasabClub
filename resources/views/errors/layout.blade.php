...
<head>
    ...
    <title>@yield('code') - @yield('title', config('app.name', 'Khasab Club'))</title>
...
<body>
    <div class="card">
        <h2 class="logo" style="font-size:1.5rem;font-weight:700;color:var(--brand);">{{ config('app.name', 'Khasab Club') }}</h2>
