        ...
        @if ($step === 2)
            <div wire:loading.class="opacity-50 pointer-events-none">
                ...
                <button wire:click="previousStep"
                    class="mt-6 inline-flex items-center gap-2 px-5 py-3 bg-white text-gray-700 hover:text-gray-900 font-semibold text-base border-2 border-gray-300 rounded-xl hover:bg-gray-50 hover:border-gray-400 shadow-sm transition-colors">
