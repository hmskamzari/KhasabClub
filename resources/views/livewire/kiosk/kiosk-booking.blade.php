            ...
            <div class="max-w-2xl mx-auto">
                ...
                @else
                    ...
                    <button wire:click="previousStep"
                        class="mt-8 inline-flex items-center gap-2 px-6 py-3.5 bg-white text-gray-700 hover:text-gray-900 font-semibold text-lg border-2 border-gray-300 rounded-xl hover:bg-gray-50 hover:border-gray-400 shadow-sm transition-colors">
